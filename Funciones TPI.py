...
#Esto es para probar las funciones unicamente, se considera que el archivo "registros.txt" seria como la agenda o lo que se quiera pasar, eso despúes va a ser una variable
#que se arma con otra función para llamar "nombre_archivo" y así podemos traer todas las matrices que queramos.
